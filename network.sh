...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.example.com docker_peer0.hospital.example.com docker_peer0.insurance.example.com
...
COMPOSE_FILE_BASE=compose-base.yaml
